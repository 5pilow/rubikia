/*
 * @(#)virtualrubik.js  1.0.4  2011-08-13
 *
...
function includeVirtualRubik(baseURL) {
  ...
  */
function attachVirtualRubik(divOrCanvas, initCallback, colors, xRot, yRot) {
  ...
  // get the console
   ...
   if (divOrCanvas==null) {
     ...
     for (i=0;i<htmlCollection.length;  i++) {
       ...
       attachVirtualRubik(elem, initCallback, colors, xRot, yRot);
     }
   } else {
     ...
     var vr=new VirtualRubik(canvasElem, colors, xRot, yRot);
  ...
  * object. 
  */
 VirtualRubik = function(canvas, colors, xRot, yRot) {
   this.canvas=canvas;
   this.additional;
   this.colors = colors;
   this.yRot = yRot;
 ...
 VirtualRubik.prototype.initScene = function() {
  ...
  this.cube3d=new RubiksCube3D(this.colors);
